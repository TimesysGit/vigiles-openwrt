###########################################################
#
# lib/llapi.py - Vigiles API interface
#
...
def api_error_message(reason: str, param: str = "", extra: str = ""):
    ...
    msg = [
        ...
        "",
        "",
        "Information about Vigies and the Vigiles CheckCVEs Service can be found at:",
        "",
        "\t%s" % VigilesInfoURL,
        "",
        "",
...
def api_get(email, key, resource, data_dict={}, json=True):
    ...
    # Encode query parameters as text to avoid adding a literal `b'...'` to the URL.
